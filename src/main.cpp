...
uint256 hashGenesisBlock("0x8e800acbf3a88a048b1d4e85955ca10f99869a2eacaf67dd753a56125a21e470");
...
const string strMessageMagic = "DeleteCoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal DeleteCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DeleteCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8e800acbf3a88a048b1d4e85955ca10f99869a2eacaf67dd753a56125a21e470");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "March 10, 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394472345; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 7331666;

        if (fTestNet)
        {
            block.nTime    = 1394472345;
            block.nNonce   = 7331666;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x39c3404421729830cf04af1554115eea601401d4fb0020831b62a06322f41d79"));
